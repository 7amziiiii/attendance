...
export default function Card({
    ...
    return (
        <Link href={href}>
            <div className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br ${gradient} p-1 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer`}>
